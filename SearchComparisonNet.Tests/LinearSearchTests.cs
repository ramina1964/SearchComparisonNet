...
public class LinearSearchTests : TestBase
{
    ...
    public void Should_return_null_index_with_linear_search_when_value_not_found(int missingValue)
    {
        // Act
        var actualIndex = LinearSut.FindItem(missingValue).TargetIndex;
